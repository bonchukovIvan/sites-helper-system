...
class BaseMessanger {
    ...
    public function create_report_message($suspected_domains, $is_slack = false): string {
        ...
        if ($is_slack) {
            ...
            $report_message .= date('m/d/Y h:m', time()) . ' ' . self::get_localization()['REPORT_TITLE'] . PHP_EOL;
        }
